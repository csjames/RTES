...
public class SerialFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.serial, container,
                false);

        Button serialBtn = (Button) rootView.findViewById(R.id.serial);

        serialBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent launchIntent = getContext().getPackageManager().getLaunchIntentForPackage("com.example.james.serialapp");
